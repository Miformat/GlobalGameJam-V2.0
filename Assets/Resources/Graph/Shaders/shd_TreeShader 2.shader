...
/////// Vectors:
                ...
                float3 lightColor = _LightColor0.rgb;
////// Lighting:
                float3 node_8248 = (_DiffuseTexture_var.rgb*lerp(_LeavesTex_var.rgb,_FlowersTex_var.rgb,(_FlowersTex_var.a*_Flowers)));
                ...
                float3 finalColor = ((lerp(node_8248,lerp((node_6977_if_leA*node_8248)+(node_6977_if_leB*1.0),node_8248,node_6977_if_leA*node_6977_if_leB),_Snow)*_LightIntensity*_LightColor0.rgb)*_DiffuseColor.rgb);
