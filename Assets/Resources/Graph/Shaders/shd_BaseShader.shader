...
////// Lighting:
                ...
                float3 node_1841 = lerp(_DiffuseTexture_var.rgb,_FresnelColor.rgb,(lerp((node_5411_if_leA*0.0)+(node_5411_if_leB*node_8871),node_8871,node_5411_if_leA*node_5411_if_leB)*_FresnelMask_var.rgb));
                ...
                float3 finalColor = ((lerp(node_1841,lerp((node_6977_if_leA*node_1841)+(node_6977_if_leB*1.0),node_1841,node_6977_if_leA*node_6977_if_leB),_Snow)*_LightIntensity*_LightColor0.rgb)*_DiffuseColor.rgb);
